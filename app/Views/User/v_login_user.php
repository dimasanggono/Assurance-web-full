        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url('AuthController/register') ?>" class="btn btn-md btn-danger btn-login px-4">Register</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 box-right">
                                        ...
                                        <div class="mb-3">
                                            Belum Punya akun?
                                            <a href="<?php echo base_url('AuthController/register') ?>" class="text-decoration-none text-dark fw-bold">Daftar Akun</a>
                                        </div>
